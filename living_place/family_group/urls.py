...
from .views import (
    FamilyGroupListView, FamilyGroupCreateView, FamilyGroupUpdateView, FamilyGroupDeleteView
)
...
urlpatterns = [
    ...
    path('create/', login_required(FamilyGroupCreateView.as_view()), name='create'),
    path('update/<int:pk>/', login_required(FamilyGroupUpdateView.as_view()), name='update'),
    path('delete/<int:pk>/', login_required(FamilyGroupDeleteView.as_view()), name='delete'),
