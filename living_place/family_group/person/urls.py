...
"""
## @namespace person.urls
#
# Contiene las rutas de la aplicación persona
...
urlpatterns = [
    ...
    path('report/', login_required(PersonReportTemplateView.as_view()), name='report')
]