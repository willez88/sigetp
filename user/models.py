...
class Pollster(models.Model):
    ...
    def __str__(self):
        ...
        return '%s %s' % (self.communal_council_level.profile.user.first_name, self.communal_council_level.profile.user.last_name)
    ...
    class Meta:
        ...
        verbose_name = _('Nivel Encuestador')
        verbose_name_plural = _('Niveles Encuestadores')
